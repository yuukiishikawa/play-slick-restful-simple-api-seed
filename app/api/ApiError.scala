...
object ApiError {
  ...
  def apply(code: Int, msg: String): ApiError = {
    ApiError(code, msg, None)

  }

  def apply(code: Int, msg: String, info: JsValue): ApiError = {
    ApiError(code, msg, Some(info))
  }

  //////////////////////////////////////////////////////////////////////
  // More factory methods used as shortcuts for common ersrors
